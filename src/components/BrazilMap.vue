<template>
  <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
    <g>
      <a @click="setState(17)" class="estado" name="Tocantins" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 17 }">
      ...
      <a @click="setState(29)" class="estado" name="Bahia" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 29 }">
      ...
      <a @click="setState(28)" class="estado" name="Sergipe" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 28 }">
      ...
      <a @click="setState(26)" class="estado" name="Pernambuco" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 26 }">
      ...
      <a @click="setState(27)" class="estado" name="Alagoas" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 27 }">
      ...
      <a @click="setState(24)" class="estado" name="Rio Grande do Norte" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 24 }">
      ...
      <a @click="setState(23)" class="estado" name="Ceará" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 23 }">
      ...
      <a @click="setState(22)" class="estado" name="Piauí" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 22 }">
      ...
      <a @click="setState(21)" class="estado" name="Maranhão" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 21 }">
      ...
      <a @click="setState(16)" class="estado" name="Amapá" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 16 }">
      ...
      <a @click="setState(15)" class="estado" name="Pará" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 15 }">
      ...
      <a @click="setState(14)" class="estado" name="Roraima" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 14 }">
      ...
      <a @click="setState(13)" class="estado" name="Amazonas" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 13 }">
      ...
      <a @click="setState(12)" class="estado" name="Acre" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 12 }">
      ...
      <a @click="setState(11)" class="estado" name="Rondônia" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 11 }">
      ...
      <a @click="setState(51)" class="estado" name="Mato Grosso" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 51 }">
      ...
      <a @click="setState(50)" class="estado" name="Mato Grosso do Sul" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 50 }">
      ...
      <a @click="setState(52)" class="estado" name="Goiás" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 52 }">
      ...
      <a @click="setState(41)" class="estado" name="Paraná" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 41 }">
      ...
      <a @click="setState(42)" class="estado" name="Santa Catarina" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 42 }">
      ...
      <a @click="setState(43)" class="estado" name="Rio Grande do Sul" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 43 }">
      ...
      <a @click="setState(35)" class="estado" name="São Paulo" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 35 }">
      ...
      <a @click="setState(31)" class="estado" name="Minas Gerais" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 31 }">
      ...
      <a @click="setState(33)" class="estado" name="Rio de Janeiro" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 33 }">
      ...
      <a @click="setState(32)" class="estado" name="Espírito Santo" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 32 }">
      ...
      <a @click="setState(53)" class="estado" name="Distrito Federal" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 53 }">
      ...
      <a @click="setState(25)" class="estado" name="Paraíba" :class="{ 'state-selected' : currentState && currentState.ibgeCode == 25 }">
...
export default {
  ...
  methods: {
    setState(ibgeCode) {
      const state = this.states.find(state => state.ibgeCode == ibgeCode)
      if(state) {
        this.currentState = state;
      }
    },
    setStateByAlias(alias) {
      const state = this.states.find(state => state.alias == alias)
      if(state) {
        this.currentState = state;  
      }
    },
...
<style scoped>
    ...
    #svg-map text {
        fill: #fff;
        font: 13px Arial-BoldMT, sans-serif;
        cursor: pointer
    }
